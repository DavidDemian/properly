    ...
    <footer className="bg-gray-900 text-white pt-16 pb-8">
      <div className="container">
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 text-center">
          <div className="inline-flex items-center bg-gray-800 rounded-full px-6 py-2 mb-6">
            <span className="text-primary mr-2">✅</span>
            <span className="text-gray-300 font-medium">Transparent Pricing</span>
            <span className="mx-3 text-gray-600">•</span>
            <span className="text-primary mr-2">✅</span>
            <span className="text-gray-300 font-medium">No Demos</span>
            <span className="mx-3 text-gray-600">•</span>
            <span className="text-primary mr-2">✅</span>
            <span className="text-gray-300 font-medium">Full Deliverables Included</span>
          </div>

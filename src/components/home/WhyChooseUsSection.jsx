...
const WhyChooseUsSection = () => {
  const reasons = [
    ...
    },
    {
      ...
      description: 'One subscription covers all your digital marketing needs, from websites to business cards to virtual tours.',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      >
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl font-light mb-8">
            "Since partnering with Properly, my online presence has completely transformed. The IDX website and NFC cards have generated more leads in the last month than I saw in the previous quarter. It's been a game-changer for my business."
          </p>
